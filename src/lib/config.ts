...
// CDC/ACM serial port at 115200 baud. WebSerial is Chrome/Edge only. Export const SERIAL_BAUD = 115200;
...
// the blocklist filters them, and the picker dialog gets overwhelmed. Export const SERIAL_FILTERS: SerialPortFilter[] = [
