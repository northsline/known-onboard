...
export const en = {
	...
	onboarding: {
		...
		connectHelpList: 'Try a different USB cable. Try a different USB port. Unplug Known, wait 5 seconds, plug it back in.',
		...
		codeHelp: 'This code is on the sticker on the bottom of your Known. If it does not match, reconnect and try again.',
		codeHelpList: 'Reconnect the device. Check the sticker on the bottom of Known. Try a different USB cable.',
		activateBtn: 'Activate',
		activating: 'Activating…',
		wifiHelp: 'Known needs your Wi-Fi name and password to connect to the internet. It will remember this network.',
		wifiHelpList: 'Check your Wi-Fi password. Make sure you are typing the correct network name. Known only works on 2.4GHz Wi-Fi, not 5GHz.',
		...
		doneHelp: 'Your dashboard will be available at known.local once your Known is plugged into the wall and has booted up.',
		doneHelpList: 'Wait 30 seconds after plugging in. Make sure Known is on the same Wi-Fi as your computer. Open known.local in your browser.',
